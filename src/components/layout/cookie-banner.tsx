...
export function CookieBanner() {
  ...
  return (
    <div className="fixed inset-x-0 bottom-[calc(7.5rem+env(safe-area-inset-bottom))] z-50 border-t border-border bg-card px-4 py-3 shadow-[0_-12px_40px_-20px_rgb(11_42_74_/_0.4)] lg:bottom-0">
